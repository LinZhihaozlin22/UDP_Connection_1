/*
 ...
 This the source code of client that emulating case-3 error (Missing end of packet identifier) of Assignment 1
 */
 ...
 int main(int argc, char *argv[]){
     ...
     //set the end_id packet 3 to a wrong value to emulate case-3 error
     packet_set[3].end_id = 0xFF0F;
