/*
 ...
 This the source code of client that emulating case-2 error (Length field doesn't match the length of payload field) of Assignment 1
 */
 ...
 int main(int argc, char *argv[]){
     ...
     // change the length field of Packet 1 to emulate the Case-2 error (length mismatch)
     packet_set[1].len = 0x20;
